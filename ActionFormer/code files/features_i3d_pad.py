...
annotation_path = "dataset/RallyDataset/activitynet_annotations_with_subset.json"
class_map = "dataset/RallyDataset/category_idx.txt"
data_path = "../video_features/rally_features_i3d_stride_4/"
block_list = "dataset/RallyDataset/missing_files.txt"
